# Github-
GitHub Docs
GitHub Packages/Working with a GitHub Packages registry/Apache Maven registry
...
Edit the distributionManagement element of the pom.xml file located in your package directory, replacing OWNER with the name of the personal account or organization that owns the repository and REPOSITORY with the name of the repository containing your project.
...
To install an Apache Maven package from GitHub Packages, edit the pom.xml file to include the package as a dependency. If you want to install packages from any repository for a specified repository owner, use a repository URL like https://maven.pkg.github.com/OWNER/*. For more information on using a pom.xml file in your project, see Introduction to the POM in the Apache Maven documentation.
